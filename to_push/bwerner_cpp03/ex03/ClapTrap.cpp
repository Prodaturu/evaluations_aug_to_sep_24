...
/*   Updated: 2024/07/25 20:34:13 by bwerner          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "ClapTrap " << this->name << " constructed with default constructor" << std::endl;
}

ClapTrap::ClapTrap(const std::string& name) : name(name), health(10), energy(10), attack_damage(0)
{
	std::cout << "ClapTrap " << this->name << " constructed with name constructor" << std::endl;
}
...
{
	std::cout << "ClapTrap " << this->name << " constructed with copy constructor" << std::endl;
}
