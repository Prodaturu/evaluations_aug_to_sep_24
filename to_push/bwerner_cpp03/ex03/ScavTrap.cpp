...
/*   Updated: 2024/07/25 21:20:30 by bwerner          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout << "ScavTrap " << this->name << " constructed with default constructor" << std::endl;
...
{
	std::cout << "ScavTrap " << this->name << " constructed with name constructor" << std::endl;
...
{
	std::cout << "ScavTrap " << this->name << " constructed with copy constructor" << std::endl;
